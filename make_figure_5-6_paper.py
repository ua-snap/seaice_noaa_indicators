...
netcdf_fn = '/workspace/Shared/Tech_Projects/SeaIce_NOAA_Indicators/project_data/nsidc_0051/NetCDF/nsidc_0051_sic_nasateam_1978-2017_Alaska_hann_{}.nc'.format(window_len)
...
for sl in [slice('1982-09-01','1986-09-30'), slice('2007-09-01','2012-09-30')]:
	...
	plt.tight_layout()
	plt.savefig('/workspace/Shared/Tech_Projects/SeaIce_NOAA_Indicators/project_data/selection_points/barrow_avg_hann_{}_{}-{}_fig5-6.png'.format(window_len, sl.start.split('-')[0],sl.stop.split('-')[0], dpi=300)
	plt.cla()
	plt.close()
