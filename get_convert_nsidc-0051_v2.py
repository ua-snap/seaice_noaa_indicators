...
def convert_GTiff( fn, output_path='/workspace/Shared/Tech_Projects/SeaIce_NOAA_Indicators/project_data/nsidc_0051_v2/GTiff/north' ):
	'''
...
if __name__ == '__main__':
	...
	base_path = '/workspace/Shared/Tech_Projects/SeaIce_NOAA_Indicators/project_data/nsidc_0051_v2'
	os.chdir( base_path )
	...
	_ = os.unlink( os.path.join( base_path, 'pub' ) )
