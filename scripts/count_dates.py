"""Create histograms of julian dates"""
...
def plot_dates_hist(fubu_ds, metric, samp_arr, plot_dir):
...
if __name__ == "__main__":
    ...
    plot_dir = os.path.join(scratch_dir, "fubu_histograms", "png")
    ...
    for metric in fubu_ds:
        plot_dates_hist(fubu_ds, metric, samp_arr, plot_dir)
