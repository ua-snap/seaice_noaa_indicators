...
def make_datetimes( timestr ):
    ''' convert a specific timestring to a datetime object '''
    # timestr = '19790703'
    year = int(timestr[:4])
...
def open_raster( fn ):
    '''
    open a gdal-readable raster with 
    rasterio. Hard-wired to return band 1.
    '''
...
if __name__ == '__main__':
    ...
    for n in [3]:
        ...
        _ = make_output_dirs( os.path.dirname(out_fn) )
        out_ds.to_netcdf( out_fn, format='NETCDF3_CLASSIC' )
