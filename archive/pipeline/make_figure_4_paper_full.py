...
if __name__ == '__main__':
	...
	fubu_fn = '/workspace/Shared/Tech_Projects/SeaIce_NOAA_Indicators/project_data/nsidc_0051/outputs/NetCDF/nsidc_0051_sic_nasateam_1979-2007_north_smoothed_fubu_dates.nc'
	fubu_clim_fn = '/workspace/Shared/Tech_Projects/SeaIce_NOAA_Indicators/project_data/nsidc_0051/outputs/NetCDF/nsidc_0051_sic_nasateam_1979-2007_north_smoothed_fubu_dates_climatology.nc'
	...
	clim_vals_pts = [ clim.sic[:,r,c].values for r,c in rowcols ]
	...
	for sl in [slice('1997-09','1998-10'), slice('2005-09','2006-10')]:
		...
		hold = [ ds_sel.sic[:,r,c].values for c,r in rowcols ]
